...
class PointsOfServiceApi
{
    ...
    {
        [$response] = $this->createPOSUsingPOSTWithHttpInfo($pos);
        return $response;
    }
    ...
    public function createPOSUsingPOSTRequest($pos)
    {
        ...
        if (isset($pos)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($pos));
            } else {
                $httpBody = $pos;
            }
    ...
    {
        [$response] = $this->getPOSDataUsingGETWithHttpInfo($id);
        return $response;
    }
    ...
    {
        [$response] = $this->getPOSListUsingGETWithHttpInfo($seller_id);
        return $response;
    }
    ...
    {
        [$response] = $this->modifyPOSUsingPUTWithHttpInfo($id, $pos);
        return $response;
    }
