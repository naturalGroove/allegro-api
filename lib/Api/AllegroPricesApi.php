...
class AllegroPricesApi
{
    ...
    {
        [$response] = $this->getAllegroPricesConsentForOfferWithHttpInfo($offer_id);
        return $response;
    }
    ...
    {
        [$response] = $this->getAllegroPricesEligibilityForAccountWithHttpInfo();
        return $response;
    }
    ...
    {
        [$response] = $this->updateAllegroPricesConsentForAccountWithHttpInfo($allegro_prices_account_change_request);
        return $response;
    }
    ...
    public function updateAllegroPricesConsentForAccountRequest($allegro_prices_account_change_request)
    {
        ...
        if (isset($allegro_prices_account_change_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($allegro_prices_account_change_request));
            } else {
    ...
    {
        [$response] = $this->updateAllegroPricesConsentForOfferWithHttpInfo($offer_id, $allegro_prices_offer_change_request);
        return $response;
    }
    ...
    public function updateAllegroPricesConsentForOfferRequest($offer_id, $allegro_prices_offer_change_request)
    {
        ...
        if (isset($allegro_prices_offer_change_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($allegro_prices_offer_change_request));
            } else {
