...
/**
 * OfferMarketplacesPriceChanges Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferMarketplacesPriceChanges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferMarketplacesPriceChanges';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the marketplace on which the price has been changed.
     *
     * @return self
     */
     ...
     * Sets change_type
     *
     * @param string|null $change_type Change type. One of MANUAL or AUTOMATIC.
     *
     * @return self
     */
