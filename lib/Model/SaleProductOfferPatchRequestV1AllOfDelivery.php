...
/**
 * SaleProductOfferPatchRequestV1AllOfDelivery Class Doc Comment
 *
 * @category Class
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 ...
 */
class SaleProductOfferPatchRequestV1AllOfDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleProductOfferPatchRequestV1_allOf_delivery';
    ...
    */
    ...
    public function setAdditionalInfo($additional_info)
    {
        ...
        if ((mb_strlen($additional_info) > 650)) {
            throw new \InvalidArgumentException('invalid length for $additional_info when calling SaleProductOfferPatchRequestV1AllOfDelivery., must be smaller than or equal to 650.');
        }
