...
class PromoOptionsCommandModification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets base_package
     *
     * @param \AllegroApi\Model\PromoOptionsCommandModificationPackage|null $base_package The base package. Available packages can be determined using <a href=\"#operation/getAvailableOfferPromotionPackages\">GET /sale/offer-promotion-packages</a>.
     *
     * @return self
     */
