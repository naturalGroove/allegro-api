...
class PickupCreateRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pickup_date_proposal_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($pickup_date_proposal_id)) {
            throw new \InvalidArgumentException('non-nullable pickup_date_proposal_id cannot be null');
        }
