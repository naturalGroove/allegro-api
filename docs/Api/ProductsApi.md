...
```php
getProductChangeProposal($change_proposal_id, $accept_language): \AllegroApi\Model\ProductChangeProposalDto
```
...
```php
productChangeProposal($product_id, $product_change_proposal_request, $accept_language): \AllegroApi\Model\ProductChangeProposalDto
```
